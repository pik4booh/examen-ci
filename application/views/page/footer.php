<footer id="footerpad">
    ...
    <script src="<?php echo base_url()?>https://cdnjs.cloudflare.com/ajax/libs/aos/2.3.4/aos.js"></script>
    <script src="<?php echo base_url()?>assets/js/PHP-Contact-Form-dark-1.js"></script>
    <script src="<?php echo base_url()?>assets/js/PHP-Contact-Form-dark.js"></script>
</body>
